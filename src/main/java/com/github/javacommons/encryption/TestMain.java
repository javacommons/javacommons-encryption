...
public class TestMain {
    ...
    public static void randomTest() {
        for (int i = 9990; i < 10000; i++) {
            ...
            AlgorithmSequence chain0 = new AlgorithmSequence();
            AlgorithmSequence chain1 = new AlgorithmSequence();
            ...
            chain1.addAlgorithm("bc::aes", sha128, 10);
            chain1.addAlgorithm("BC::Blowfish", sha128, 10);
    ...
    public static void main(String[] args) {
        ...
        AlgorithmSequence en = new AlgorithmSequence();
        //en.addCryptoEngine("Blowfish", sha256, 10);
        en.addAlgorithm("AES", sha256, 1);
